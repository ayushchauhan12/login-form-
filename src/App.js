...
function App() {
  ...
  >
    <div className="inner-element">
      ...
      <div className="inp"><PersonIcon/><CssTextField className="sty" id="custom-css-outlined-input"  label="UserName" /></div>


      {/* ye color change krna ho label ka to label ki jgh placehlder use krlo par aesa krne se jo effect label se aara h textfield me click krne pe wo placeholder me ni ara */}
      <div className="inp"><LockIcon/><CssTextField id="custom-css-outlined-input" label="password"  /></div>
